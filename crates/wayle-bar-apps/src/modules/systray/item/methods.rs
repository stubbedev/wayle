...
impl SystrayItem {
    pub fn request_menu_show(&self, sender: &FactorySender<Self>) {
    ...
    pub fn ensure_popover(&mut self, menu: &gio::Menu) -> gtk::PopoverMenu {
    ...
    pub fn apply_menu_model(&mut self, popover: &gtk::PopoverMenu, model: TrayMenuModel) {
    ...
    pub fn update_icon(&mut self, image: &gtk::Image) {
    ...
    pub fn rebuild_menu_if_visible(&mut self) {
