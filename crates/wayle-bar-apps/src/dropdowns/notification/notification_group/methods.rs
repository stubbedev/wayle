...
impl NotificationGroup {
    pub fn reconcile_items(&mut self, notifications: Vec<Arc<Notification>>) {
    ...
    pub fn reset_to_default_cap(&mut self) {
    ...
    pub fn show_all_items(&mut self) {
