...
impl NotificationItem {
    pub fn apply_icon(&self, icon: &gtk::Image, icon_container: &gtk::Box) {
    ...
    pub fn build_action_buttons(&self, actions_box: &gtk::Box) {
    ...
    pub fn setup_default_action(&self, main_row: &gtk::Box) {
    ...
    pub fn time_to_string(time: RelativeTime) -> String {
        match time {
