...
#[derive(Debug, Clone)]
pub(crate) struct SwayWorkspaceButtonInit {
    pub id: u64,
...
pub(crate) struct SwayWorkspaceButton {
    pub(super) id: u64,
...
#[derive(Debug)]
pub(crate) enum SwayWorkspaceButtonInput {}

#[derive(Debug)]
pub(crate) enum SwayWorkspaceButtonOutput {
    LeftClick(u64),
    MiddleClick(u64),
    RightClick(u64),
    ScrollUp,
