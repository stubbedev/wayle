...
pub(super) fn select_icon(config: &PowerProfilesConfig, profile: PowerProfile) -> String {
    match profile {
...
pub(super) fn format_label(format: &str, profile: PowerProfile) -> String {
...
pub(super) fn next_profile(current: PowerProfile, available: &[PowerProfile]) -> PowerProfile {
