...
use wayle_config::{
    Config,
    schemas::modules::sway_workspaces::{ICON_BASE_REM, LABEL_BASE_REM},
};
...
pub(crate) fn entry(config: &Config) -> LeafEntry {
    let module = &config.modules.sway_workspaces;

    LeafEntry {
        id: "sway-workspaces",
        i18n_key: "settings-nav-sway-workspaces",
        icon: "ld-grid-2x2-symbolic",
        spec: page_spec(
            "settings-page-sway-workspaces",
            vec![
                SectionSpec {
