...
use crate::{
    editors::{icon::icon, number::number_u64, text::text},
    pages::{
        nav::LeafEntry,
        sections::bar_button::{
...
pub(crate) fn entry(config: &Config) -> LeafEntry {
    let module = &config.modules.netstat;
    ...
    LeafEntry {
        ...
        spec: page_spec(
            ...
            vec![
                ...
                actions_section(&fields, &crate::pages::sections::action_choices::choices_for("netstat")),
            ],
        ),
    }
}
