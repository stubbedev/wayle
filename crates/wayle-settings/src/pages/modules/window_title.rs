...
use crate::{
    editors::{icon::icon, string_map::string_map, text::text},
    pages::{
        nav::LeafEntry,
        sections::bar_button::{
...
pub(crate) fn entry(config: &Config) -> LeafEntry {
    let module = &config.modules.window_title;
    ...
    LeafEntry {
        ...
        spec: page_spec(
            ...
            vec![
                ...
                actions_section(&fields, &crate::pages::sections::action_choices::choices_for("window-title")),
            ],
        ),
    }
}
