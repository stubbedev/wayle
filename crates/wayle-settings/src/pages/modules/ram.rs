...
pub(crate) fn entry(config: &Config) -> LeafEntry {
    ...
    LeafEntry {
        id: "ram",
        i18n_key: "settings-nav-ram",
        icon: "ld-memory-stick-symbolic",
        spec: page_spec(
            "settings-page-ram",
            vec![
                SectionSpec {
                ...
                actions_section(&fields, &crate::pages::sections::action_choices::choices_for("ram")),
            ],
        ),
    }
}
