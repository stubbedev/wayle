//! World clock module settings.

use wayle_config::Config;

use crate::{
    editors::{icon::icon, text::text},
    pages::{
        nav::LeafEntry,
        sections::bar_button::{
...
pub(crate) fn entry(config: &Config) -> LeafEntry {
    let module = &config.modules.world_clock;
    ...
    LeafEntry {
        id: "world-clock",
        i18n_key: "settings-nav-world-clock",
        icon: "ld-globe-symbolic",
        spec: page_spec(
            "settings-page-world-clock",
            vec![
                SectionSpec {
                ...
                actions_section(&fields, &crate::pages::sections::action_choices::choices_for("world-clock")),
            ],
        ),
    }
}
