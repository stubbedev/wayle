//! Treeman worktree-health module settings.
...
pub(crate) fn entry(config: &Config) -> LeafEntry {
    let module = &config.modules.treeman;
    ...
    LeafEntry {
        id: "treeman",
        i18n_key: "settings-nav-treeman",
        icon: "ld-layers-symbolic",
        spec: page_spec(
            "settings-page-treeman",
            vec![
                SectionSpec {
                ...
                actions_section(
                    &fields,
                    &crate::pages::sections::action_choices::choices_for("treeman"),
                ),
            ],
        ),
    }
