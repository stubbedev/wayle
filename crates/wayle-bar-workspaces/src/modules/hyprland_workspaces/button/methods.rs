...
impl WorkspaceButton {
    ...
    pub fn apply_urgency(&mut self, is_urgent: bool, urgent_addresses: &HashSet<Address>) {
    ...
    pub fn current_css_classes(&self) -> Vec<&str> {
    ...
    pub fn populate_identity(&self, container: &gtk::Box) {
