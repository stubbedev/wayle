...
pub fn resolve_workspace_icons(
...
pub fn has_title_patterns(user_map: &BTreeMap<String, String>) -> bool {
...
pub fn workspace_id_css_class(id: WorkspaceId) -> String {
    if id < 0 {
...
pub fn matches_ignore_patterns(id: WorkspaceId, patterns: &[String]) -> bool {
...
pub fn compute_static_css_classes(
    id: WorkspaceId,
...
pub fn collect_button_css_classes<'a>(
...
pub fn should_show_divider(show_app_icons: bool, divider: &str, display_mode: DisplayMode) -> bool {
    show_app_icons && !divider.is_empty() && display_mode != DisplayMode::None
}

pub fn compute_display_id(
    id: WorkspaceId,
    numbering: Numbering,
...
pub fn addresses_in_workspace<A: Clone>(
    workspace_id: WorkspaceId,
    client_workspaces: &[(A, WorkspaceId)],
) -> Vec<A> {
    client_workspaces
...
pub fn prune_stale_addresses<A: Eq + std::hash::Hash + Clone>(
    urgent_addresses: &HashSet<A>,
