//! [`NiriWorkspaceButton`] private helpers: state-driven rendering decisions.
...
use super::{NiriWorkspaceButton, NiriWorkspaceButtonInit};
use crate::shell::bar::modules::niri_workspaces::helpers;
...
impl NiriWorkspaceButton {
    ...
    pub fn populate_app_icons(&mut self, container: &gtk::Box, urgent_window_ids: &HashSet<u64>) {
...
pub fn compute_css_classes(init: &NiriWorkspaceButtonInit) -> Vec<String> {
