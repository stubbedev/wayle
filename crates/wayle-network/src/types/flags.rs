...
bitflags! {
    ...
    pub struct NMSecretAgentGetSecretsFlags: u32 {
        ...
        const ALLOW_INTERACTION = 0x0000_0001;
        ...
        const USER_REQUESTED = 0x0000_0004;
        ...
        const WPS_PBC_ACTIVE = 0x0000_0008;
    ...
    pub struct NMSettingsAddConnection2Flags: u32 {
        ...
        const TO_DISK = 0x0000_0001;
        /// to make the connection in-memory only.
        const IN_MEMORY = 0x0000_0002;
        ...
        const BLOCK_AUTOCONNECT = 0x0000_0020;
    }
    ...
    pub struct NMSettingsUpdate2Flags: u32 {
        ...
        const IN_MEMORY_DETACHED = 0x0000_0004;
        ...
        /// be chosen.
        const IN_MEMORY_ONLY = 0x0000_0008;
    ...
    pub struct NMCheckpointCreateFlags: u32 {
        ...
        const TRACK_INTERNAL_GLOBAL_DNS = 0x0000_0020;
    }
    ...
    pub struct NMConnectionSettingsFlags: u32 {
        ...
        const NM_GENERATED = 0x0000_0002;
    ...
    pub struct NMDeviceInterfaceFlags: u32 {
        ...
        const CARRIER = 0x0001_0000;
        /// the flag to indicate device LLDP status. Since: 1.32.
        const LLDP_CLIENT_ENABLED = 0x0002_0000;
    }
