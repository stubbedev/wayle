...
impl WayleDaemon {
    ...
    #[zbus(property)]
    pub fn popup_duration(&self) -> u32 {
    ...
    pub fn count(&self) -> u32 {
        u32::try_from(self.service.notifications.get().len()).unwrap_or(u32::MAX)
    }

    /// Number of active popups.
    #[zbus(property)]
    pub fn popup_count(&self) -> u32 {
        u32::try_from(self.service.popups.get().len()).unwrap_or(u32::MAX)
    }
}
