...
cp resources/com.wayle.vpn-sso-callback.desktop "${STAGING}/"
cp resources/wayle-settings.svg "${STAGING}/"
cp resources/90-wayle-openconnect-detach "${STAGING}/"
cp resources/90-wayle-openconnect-detach.conf "${STAGING}/"
